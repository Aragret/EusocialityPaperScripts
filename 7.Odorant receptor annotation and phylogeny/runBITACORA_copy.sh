...
SCRIPTDIR=/global/research/ebb/amikhail/programs/bitacora/Scripts
...
GEMOMAP=/global/research/ebb/amikhail/programs/GeMoMa/GeMoMa-1.7.1.jar
...
GENOME=/EBB-ZIVNFS/amikhail/termite_genomes/annotated_assemblies/gff3/Apac_maskedGenome.fna

# Include the GFF3 or GTF file
GFFFILE=/EBB-ZIVNFS/amikhail/termite_genomes/annotated_assemblies/gff3/Apac_genes.gff3

# Include the fasta file containing the GFF predicted proteins
PROTFILE=/EBB-ZIVNFS/amikhail/termite_genomes/annotated_assemblies/gff3/.Apac_proteins_rep.faa
...
QUERYDIR=/EBB-ZIVNFS/amikhail/termite_genomes/eusociality_paper/analyses/chemoreceptors/ORs/OR_database
