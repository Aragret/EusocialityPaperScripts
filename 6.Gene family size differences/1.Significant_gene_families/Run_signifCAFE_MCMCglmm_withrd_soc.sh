...
#SBATCH --job-name=sigrdsoc                          # replace the name 
#SBATCH --mail-type=none
#SBATCH --ntasks=1  
#SBATCH --cpus-per-task=1
#SBATCH --mem-per-cpu=360                                        # replace with amount suitable for your job
#SBATCH --time=01:35:30                                           # replace with amount suitable for your job
#SBATCH --qos=standard
#SBATCH --partition=main,scavenger

module load R/4.2.2-foss-2022b

dos2unix data/selected_HOG.txt
input_list="data/selected_HOG.txt" 
...
Rscript signifCAFE_MCMCglmm_withrd_soc.R $hog
