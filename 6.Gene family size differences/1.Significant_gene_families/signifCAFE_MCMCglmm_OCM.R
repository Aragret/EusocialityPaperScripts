...
print("saving...")
save(model, file = paste0("signifCAFE/Gaussian model for HOG ",hog," gene_count vs Ontogenic_complexity_metric with expanded priors and without random IDs.Rdata"))
print("Done1")
...
print("saving...")
save(model, file = paste0("signifCAFE/Gaussian model for HOG ",hog," gene_count vs Ontogenic_complexity_metric with iw priors and without random IDs.Rdata"))
print("Done1")