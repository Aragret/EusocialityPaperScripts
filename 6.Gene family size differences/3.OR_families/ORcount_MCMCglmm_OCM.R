...
hog = args[1]
print(hog)
print(paste0("Gaussian model for HOG ",hog," gene_count vs Ontogenic_complexity_metric with expanded priors and without random IDs"))
...
print("saving...")
save(model, file = paste0("ORcount_models_OCM/Gaussian model for HOG ",hog," gene_count vs Ontogenic_complexity_metric with expanded priors and without random IDs.Rdata"))
print("Done1")

print(paste0("Gaussian model for HOG ",hog," gene_count vs Ontogenic_complexity_metric with iw priors and without random IDs"))
...
print("saving...")
save(model, file = paste0("ORcount_models_OCM/Gaussian model for HOG ",hog," gene_count vs Ontogenic_complexity_metric with iw priors and without random IDs.Rdata"))
print("Done1")
