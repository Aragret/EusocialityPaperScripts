...
print("saving...")
save(model, file = paste0("ORcount_models/Gaussian model for HOG ",hog," gene_count vs Social_category with expanded priors and with random IDs.Rdata"))
print("Done1")
...
print("saving...")
save(model, file = paste0("ORcount_models/Gaussian model for HOG ",hog," gene_count vs Social_category with iw priors and with random IDs.Rdata"))
print("Done1")
