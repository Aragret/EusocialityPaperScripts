...
#SBATCH --job-name=gcMCsoc                          # replace the name 
#SBATCH --mail-type=none
#SBATCH --ntasks=1  
#SBATCH --cpus-per-task=1
#SBATCH --mem-per-cpu=340                                        # replace with amount suitable for your job
...
dos2unix data/selected_OR_OG_list.txt
input_list="data/selected_OR_OG_list.txt" 
...
Rscript ORcount_MCMCglmm_withrd_soc.R $hog