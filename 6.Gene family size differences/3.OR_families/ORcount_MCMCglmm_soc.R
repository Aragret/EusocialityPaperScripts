...
hog = args[1]
print(hog)
print(paste0("Gaussian model for HOG ",hog," gene_count vs Social_category with expanded priors and without random IDs"))
...
print("saving...")
save(model, file = paste0("ORcount_models/Gaussian model for HOG ",hog," gene_count vs Social_category with expanded priors and without random IDs.Rdata"))
print("Done1")

print(paste0("Gaussian model for HOG ",hog," gene_count vs Social_category with iw priors and without random IDs"))
...
print("saving...")
save(model, file = paste0("ORcount_models/Gaussian model for HOG ",hog," gene_count vs Social_category with iw priors and without random IDs.Rdata"))
print("Done1")
