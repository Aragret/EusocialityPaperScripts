...
hog = args[1]
print(hog)
print(paste0("Gaussian model for HOG ",hog," gene_count vs Ontogenic_complexity_metric with expanded priors and with random IDs"))

data_subhog = subset(data, data$Family_ID == hog)
model <- MCMCglmm(gene_count ~ Ontogenic_complexity_metric,
                  random = ~Species + random_id,
                  family = "gaussian",
...
print("saving...")
save(model, file = paste0("ORcount_models_OCM/Gaussian model for HOG ",hog," gene_count vs Ontogenic_complexity_metric with expanded priors and with random IDs.Rdata"))
print("Done1")

print(paste0("Gaussian model for HOG ",hog," gene_count vs Ontogenic_complexity_metric with iw priors and with random IDs"))
...
print("saving...")
save(model, file = paste0("ORcount_models_OCM/Gaussian model for HOG ",hog," gene_count vs Ontogenic_complexity_metric with iw priors and with random IDs.Rdata"))
print("Done1")
