...
print("saving...")
save(model, file = paste0("leftover_models/Gaussian model for HOG ",hog," gene_count vs Ontogeny with expanded priors and without random IDs.Rdata"))
print("Done1")
...
print("saving...")
save(model, file = paste0("leftover_models/Gaussian model for HOG ",hog," gene_count vs Ontogeny with iw priors and without random IDs.Rdata"))
print("Done1")
