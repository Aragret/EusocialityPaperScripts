...
hog = args[1]
print(hog)
print(paste0("Gaussian model for HOG ",hog," gene_count vs Social_category with expanded priors and with random IDs"))

data_subhog = subset(data, data$Family_ID == hog)
model <- MCMCglmm(gene_count ~ Social_category,
...
print("saving...")
save(model, file = paste0("leftover_models/Gaussian model for HOG ",hog," gene_count vs Social_category with expanded priors and with random IDs.Rdata"))
print("Done1")

print(paste0("Gaussian model for HOG ",hog," gene_count vs Social_category with iw priors and with random IDs"))
...
print("saving...")
save(model, file = paste0("leftover_models/Gaussian model for HOG ",hog," gene_count vs Social_category with iw priors and with random IDs.Rdata"))
print("Done1")
