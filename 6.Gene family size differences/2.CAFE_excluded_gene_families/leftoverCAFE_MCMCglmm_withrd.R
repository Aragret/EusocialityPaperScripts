...
hog = args[1]
print(hog)
print(paste0("Gaussian model for HOG ",hog," gene_count vs Ontogeny with expanded priors and with random IDs"))
...
print("saving...")
save(model, file = paste0("leftover_models/Gaussian model for HOG ",hog," gene_count vs Ontogeny with expanded priors and with random IDs.Rdata"))
print("Done1")

print(paste0("Gaussian model for HOG ",hog," gene_count vs Ontogeny with iw priors and with random IDs"))
...
print("saving...")
save(model, file = paste0("leftover_models/Gaussian model for HOG ",hog," gene_count vs Ontogeny with iw priors and with random IDs.Rdata"))
print("Done1")
