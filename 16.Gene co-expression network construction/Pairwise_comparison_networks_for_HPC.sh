...
#SBATCH --job-name=codinap
#SBATCH --mail-type=none
#SBATCH --ntasks=1  
#SBATCH --cpus-per-task=1
#SBATCH --mem-per-cpu=120g                                   # replace with amount suitable for your job
#SBATCH --time=10:30:00                                           # replace with amount suitable for your job
#SBATCH --qos=standard
...
Rscript Pairwise_comparison_networks_for_HPC.R $spe
